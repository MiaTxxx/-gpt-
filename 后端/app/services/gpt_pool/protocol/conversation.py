...
from app.services.gpt_pool.openai_backend_api import OpenAIBackendAPI
from app.services.gpt_pool.helper import IMAGE_MODELS, extract_image_from_message_content
